...
src/%.o: ../src/%.c src/subdir.mk
	...
	arm-none-eabi-gcc -DDEBUG -D__CODE_RED -D__REDLIB__ -I"C:\Users\student\Downloads\10_04\Lib_CMSISv1p30_LPC17xx\inc" -I"C:\Users\student\Downloads\10_04\Lib_FatFs_SD\inc" -I"C:\Users\student\Downloads\10_04\Lib_MCU\inc" -O0 -g3 -gdwarf-4 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fmerge-constants -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m3 -mthumb -D__REDLIB__ -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
